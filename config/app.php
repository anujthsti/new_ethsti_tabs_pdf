...
return [
    ...
    */
    ...
    'url' => env('APP_URL', $domainUrl),

    //'asset_url' => env('ASSET_URL', null),
    'asset_url' => env('ASSET_URL', $domainUrl.'/public'),
    ...
    */
    ...
    'bildesk' => [
        ...
        'security_id' => 'thsti',
        'currency_type' => 'INR',
        'test_checksum_key' => 'G3eAmyVkAzKp8jFq0fqPEqxF4agynvtJ',
        'thsti_checksum_key' => 'R9WAJJK5uo26CEcdxrOhonF6O7zqp9LU',
        'callback_url' => $domainUrl.'/application/payment_response',
        'crone_api_url' => 'https://www.billdesk.com/pgidsk/PGIQueryController'
    ],
