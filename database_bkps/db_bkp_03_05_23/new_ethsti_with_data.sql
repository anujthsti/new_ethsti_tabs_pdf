...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2023 at 02:52 PM
...
INSERT INTO `candidates_jobs_apply` (`id`, `candidate_id`, `rn_no_id`, `job_id`, `domain_id`, `appointment_method_id`, `is_ex_serviceman`, `is_esm_reservation_avail`, `is_govt_servent`, `type_of_employment`, `type_of_employer`, `is_pwd`, `category_id`, `marital_status`, `application_status`, `trainee_category_id`, `institute_name`, `is_experience`, `total_experience`, `age_calculated`, `is_publication`, `relative_name`, `relative_designation`, `relative_relationship`, `data_status`, `file_status`, `payment_status`, `is_completed`, `hr_additional_remarks`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 10, 2, 29, 31, 0, 0, 1, 1, 118, 1, 37, 2, 0, NULL, NULL, 1, '7 YEARS,1 MONTHS,24 DAYS', '31 Year, 00 Months, 8 Days', 1, 'Satyam Kumar', 'Programmer', 'Friend', 1, 0, 0, 0, NULL, 1, '2023-03-14 04:55:38', '2023-04-28 06:39:39');
