...
CREATE TABLE `candidates_academics_documents` (
  ...
  `status` int(11) NOT NULL COMMENT '1 for active,\r\n2 for inactive,\r\n3 for delete',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
(1, 1, 10, 2, 29, 31, 0, 0, 37, 0, NULL, NULL, 1, '7 YEARS,1 MONTHS,24 DAYS', 1, 'Satyam Kumar', 'Programmer', 'Friend', 1, 0, 0, 1, '2023-03-14 04:55:38', '2023-04-03 01:18:26');
