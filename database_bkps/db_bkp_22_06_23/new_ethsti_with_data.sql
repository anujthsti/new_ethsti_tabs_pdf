...
INSERT INTO `shortlisted_results` (`id`, `rn_no_id`, `job_id`, `shortlisted_title`, `date_of_interview`, `alternate_text`, `upload_file`, `announcement`, `status`, `created_at`, `updated_at`) VALUES
(1, 10, 2, 'Test Shortlisted Result', '2023-06-20', 'Test Alt Text', '168622565402Shortlisted-Result-(Group---A).docx.pdf', 'test announcement', 1, '2023-06-20 04:52:28', '2023-06-21 04:55:35');
