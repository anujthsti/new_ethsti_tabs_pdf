...
<x-app-layout>
    ...
    <div class="container mt-2">
        ...
        <form method="post" name="candidate_print" action="<?php echo $formAction; ?>" class="border border-dark" >
            @csrf
            <table border="0" align="center" cellpadding="2" cellspacing="2" id="print_form_id" class="table-sm11">
                <tr>
                ...
                <tr>
                    ...
                    <td align="right" valign="top"><strong>RN No. </strong><?php echo $jobDetails[0]['rn_no']; ?></td>
                </tr>
                <?php 
                ...
                if(isset($candidateApplyDetails[0]['age_calculated']) && !empty($candidateApplyDetails[0]['age_calculated'])){ 
                ...
                <tr style="background-color:#CCC;">
                    <td colspan="3" align="left" valign="top"><strong>ACADEMIC/ PROFESSIONAL QUALIFICATION</strong></td>
                </tr>      
                <tr>
                    <td colspan="3" align="left" valign="top">
                ...
                <tr style="background-color:#CCC;">
                    <td colspan="3" align="left" valign="top"><strong>EXPERIENCE Details</strong></td>
                </tr>
                <tr>
                    <td colspan="3" align="left" valign="top">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-lg-12">
                                ...
                                if(isset($candidatesJobHRRemarks) && !empty($candidatesJobHRRemarks)){ 
                                    ...
                                    $codes = implode(", ",$codes);    
                                ?>
                                    <span class="text-danger"><?php echo $codes;?></span> 
                                <?php } ?>
                            </label>
                            
                            <select class="form-control col-lg-12" name="hr_remarks[]" id="hr_remarks" multiple  style="height:450px; width:1070px; "> 
