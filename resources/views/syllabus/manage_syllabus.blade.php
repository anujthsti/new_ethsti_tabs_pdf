...
<?php
    ...
    $headerTitle = "Manage Syllabus";
    // variables for section buttons bar
    $createBtnTitle = "Add Syllabus";
    $createBtnLink = route('add_syllabus');
?>
            ...
            <tbody>
                ...
                @foreach ($syllabus as $result)
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- action html start -->
                            <form action="{{ route('delete_syllabus',$encId) }}" method="Post">
                                <a class="btn btn-primary" href="{{ route('edit_syllabus',$encId) }}"><i class="fa fa-pencil"></i></a>
                                @csrf
                                @method('DELETE')
